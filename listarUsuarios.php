               ...
               <div class="Adm">
                    <section>
                            ...
                            <form action="includes/logica/controller.php" method="post">
                                <button type="submit" class="btn btn-success" name="editar" value="<?php echo $pessoa['codpessoa']; ?>"> Editar </button>
                                <button type="submit" class="btn btn-danger" name="deletar" value="<?php echo $pessoa['codpessoa']; ?>" onclick = "return confirma_excluir()"> Deletar </button> 
                            </form>
                            <br><br>                                                          
                        </section>
               </div>
